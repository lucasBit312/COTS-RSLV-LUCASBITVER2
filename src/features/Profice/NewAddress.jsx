...
function NewAddress(props) {
  ...
  const [wardNew, setWardNew] = useState(selectedAddress?.ward_id || "");
  ...
  return (
    <form onSubmit={handleSubmitUpdateAddress(onSubmitUpdateAddress)}>
      <DialogContent>
        ...
        {provinceNew && (
          <FormControl style={{ marginTop: "24px", width: "100%" }}>
            <InputLabel id="label-province">Quận/Huyện</InputLabel>
            <Select
        ...
        {districtNew && (
          <FormControl style={{ marginTop: "24px", width: "100%" }}>
            <InputLabel id="label-province">Huyện/Xã</InputLabel>
            <Select
              labelId="label-ward"
              id="ward_id"
              value={wardNew}
      ...
      <div className="text-end">
        ...
        <Button className="mr-2" onClick={closeDialog}>Hủy</Button>
      </div>
    </form>
  );
}
