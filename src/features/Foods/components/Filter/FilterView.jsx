...
const FILTER_LIST = [
    ...
    },
    {
        ...
        isActive: () => true,
        isChange: () => true,
        isVisible: (filters) => filters.province_id !== undefined,
        isRemovable: true,
        onRemove: (filters) => {
            const newFilters = { ...filters };
            delete newFilters.province_id;
            delete newFilters.district_id;
            delete newFilters.ward_id;
    ...
    },
    {
        ...
        isActive: () => true,
        isVisible: (filters) => filters.district_id !== undefined,
        isRemovable: true,
        onRemove: (filters) => {
            const newFilters = { ...filters };
            delete newFilters.district_id;
    ...
    },
    {
        ...
        isActive: () => true,
        isVisible: (filters) => filters.ward_id !== undefined,
        isRemovable: true,
        onRemove: (filters) => {
            const newFilters = { ...filters };
            delete newFilters.ward_id;
