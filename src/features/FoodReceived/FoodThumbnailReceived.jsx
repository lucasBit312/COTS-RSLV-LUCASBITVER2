...
//   useEffect(() => {
//     if (food?.images && food?.images.length > 4) {
//       setShowArrows(true);
//     } else {
//       setShowArrows(false);
//     }
...
//       prev < (food?.images?.length || 0) - 1 ? prev + 1 : prev
//     );
//   };
...
//           )}
//           <ThumbnailImage
//             src={`${baseURL}${food?.images?.[displayedImage]?.image_url}`}
//             alt={food?.title}
//             isSelected
//           />
...
function FoodThumbnailReceived(props) {
  return <div></div>;
}
